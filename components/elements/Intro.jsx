    ...
    <Box className="intro" my={32}>
      <Container maxW={800}>
        ...
        <Grid gridTemplateColumns={["1fr", null, "1fr 1fr"]} gap={8}>
          <GridItem>
            <Image src="/assets/store1.jpg" rounded="xl" />
          </GridItem>
          <GridItem>
            <Heading size="lg">
            ...
            <Text mt={4}>
              ...
              laboriosam, veniam vel dolorum enim laborum consectetur
              repudiandae fuga tempore odit consequuntur doloremque recusandae
              delectus quam? Animi fuga pariatur officiis rerum officia tempore
              tenetur, rem totam debitis, temporibus eum amet nihil.
            </Text>
        ...
        <Grid gridTemplateColumns={["1fr", null, "1fr 1fr"]} gap={8} mt={16}>
          <GridItem order={{ base: 0, md: 1 }}>
            <Image src="/assets/store2.jpg" rounded="xl" />
          </GridItem>
